...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' '-Rxyhn' '-Horizon' '-Monochrome')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|rxyhn|horizon|monochrome|all]  (Nord/Dracula/Gruvbox/Everforest/Catppuccin/Rxyhn/Horizon/Monochrome/all) ColorSchemes version
