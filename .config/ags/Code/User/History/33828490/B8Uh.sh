...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' '-Rxyhn')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|rxyhn|all]  (Nord/Dracula/Gruvbox/Everforest/Catppuccin/Rxyhn/all) ColorSchemes version
