...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' '-Rxyhn' '-Horizon' '-Monochrome' '-Tokyonight' '-Onedark')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|rxyhn|horizon|monochrome|tokyonight|onedark|all]  (Nord/Dracula/Gruvbox/Everforest/Catppuccin/Rxyhn/Horizon/Monochrome/Tokyonight/Onedark/all) ColorSchemes version
      ...
      for variant in $@; do
        case "$variant" in
          ...
          rxyhn)
            ...
            echo -e "\nRxyhn ColorScheme version! ..."
            shift
            ;;
          horizon)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[7]}")
            echo -e "\nHorizon ColorScheme version! ..."
            shift
            ;;
          monochrome)
            colorscheme='true'
            schemes+=("${SCHEME_VARIANTS[8]}")
            echo -e "\nMonochrome ColorScheme version! ..."
            shift
            ;;
          tokyonight)
            colorscheme='true'
  ...
  if [[ "$scheme" != '' ]]; then
    case "$scheme" in
      ...
      -Rxyhn)
        ...
        ;;
      -Horizon)
        scheme_color='horizon'
        ;;
      -Monochrome)
        scheme_color='monochrome'
        ;;
      -Tokyonight)
        scheme_color='tokyonight'
        ;;
      -Onedark)
        scheme_color='onedark'
        ;;     
    esac
