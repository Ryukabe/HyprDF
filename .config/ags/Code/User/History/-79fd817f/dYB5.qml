...
PanelWindow {
    ...
    Rectangle {
        ...
        Column {
            ...
            Text { anchors.horizontalCenter: parent.horizontalCenter; text: Qt.formatDateTime(clock.date, "hh:mm"); color: Colors.blue; font { pixelSize: 26; weight: 600 } }
            Text { anchors.horizontalCenter: parent.horizontalCenter; text: Qt.formatDateTime(clock.date, "dddd, MMMM d"); color: Colors.grey2; font.pixelSize: 13 }
        }
    }
}
