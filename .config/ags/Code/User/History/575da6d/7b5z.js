...
// Simple interface for StatusNotifierItem
const SNI_INTERFACE = `
<node>
...
function createTrayIcon() {
    ...
    const sniObject = Gio.DBusExportedObject.wrapJSObject(nodeInfo.interfaces[0], {
        ...
        ContextMenu: (x, y) => {
            // On right-click show the context menu
            // The menu should appear automatically via DBus
        }
    });
...
// Add function to stop all timers
